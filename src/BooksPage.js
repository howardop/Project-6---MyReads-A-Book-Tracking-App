...
class BooksPage extends React.Component {
    state = {
     currentlyReading: ['{<li> <Book      coverUrl="http://books.google.com/books/content?id=PGR2AwAAQBAJ&printsec=frontcover&img=1&zoom=1&imgtk=AFLRE73-GnPVEyb7MOCxDzOYF1PTQRuf6nCss9LMNOSWBpxBrz8Pm2_mFtWMMg_Y1dx92HT7cUoQBeSWjs3oEztBVhUeDFQX6-tWlWz1-feexS0mlJPjotcwFqAg6hBYDXuK_bkyHD-y&source=gbs_api" bookTitle="To Kill a Mockingbird"       bookAuthors="Harper Lee"   />  </li>}'],
      i: null
    }
    render() {
        return (
